...
<html>
	...
	<body>
		...
		<h2 style="padding: 20px; margin-left: 500px;">AVAILABLE TRAINS</h2>
		<?php
			if(isset($_POST['Search']))
			{
				...
				if(empty($data_missing))
				{
					...
					if($class=="economy")
					{
						...
						{
							echo "<h2>Oops  🛤  </h2><br><h3> No Trains are available from </h3> <label> " . $origin . "</label><h3>to </h3> <label> ". $destination . "</label> <h3>on </h3> <label>" .$dep_date. "</label>" ;
						}
						else
						{
							echo "<form action=\"book_tickets2.php\" method=\"post\">";
							echo "<table style=\"margin-left: 160px;\" cellpadding=\"13\"";
    						...
    						echo "</table> <br>";
    						echo "<input style=\"margin-left: 600px; margin-top: 20px;\" type=\"submit\" value=\"Select Train\" name=\"Select\">";
    						echo "</form>";
    					}
					}
					else if($class="business")
					{
						...
						if(mysqli_stmt_num_rows($stmt)==0)
						{
							echo "<h3>No trains are available !</h3>";
						}
						else
						{
							echo "<form action=\"book_tickets2.php\" method=\"post\">";
