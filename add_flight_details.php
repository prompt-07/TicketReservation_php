...
<html>
	...
	<body>
		...
		<fieldset style="margin: 50px; margin-left:250px; width: 65%;">
			<legend><h2>ENTER THE FLIGHT SCHEDULE DETAILS <i class="fa fa-train"></i></h2></legend>
			<?php
			...
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Engine ID</td>
				</tr>
				<tr>
					<td class="fix_table">
			...
			<br>
			<input type="submit" value="Submit" name="Submit" style="margin-top: 10px; margin-left: 400px;padding: 10px;">
		</fieldset>
		</form>
	</body>
</html>